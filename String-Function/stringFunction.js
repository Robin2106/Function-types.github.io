let NameOfString ="  Welcome to the Besant Tech  ";
...
let searchTheWord = NameOfString.includes('Tech');
console.log(searchTheWord);

let searchTheWordWithPosition = NameOfString.includes('Tech',10);
...
let replaceString = NameOfString.replace('Tech','Institue');
