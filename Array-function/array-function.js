let studentNames = ['Sabari','Chinapa','Robin','Priya','Karthi','Ranjith','Mano']
console.log("Students Name : ");
console.log(studentNames);

// Insert an element at end
studentNames.push('Kiruba');
console.log('New element added in the end : ');
console.log( studentNames);

// Insert an element at front
studentNames.unshift('Anish');
console.log('New element added in the end : ');
console.log(studentNames);
...
studentNames.splice(4,1,'Anisha');
console.log('a student name added to the specific place');
console.log(studentNames);

studentNames.splice(4,1,'Angel','Nerupu Kumar');
...
let findElement = studentNames.includes('Robin');
